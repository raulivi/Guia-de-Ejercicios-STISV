 ...
 * @author Raul
 */
public class Guia_Ejercicios_STISV {

   
    public static void main(String[] args) {
        System.out.println("SELECCIÓN DE TÉCNICAS DE INGENIERÍA DE SOFTWARE\nGuia de ejercicios prácticos Java – Estructuras de control");
        System.out.println("Integrantes:\nOscar Alejandro Romualdo Artiga (350516)\n"+
                            "Rosa Elena Salomón Méndez (372816)\n" +
                            "José Raúl Escalante Aparicio (389216)\n" +
                            "Adali Antonia Rendón Vásquez 131816");
        System.out.println("Grupo: SISV11-A");
        /*
1) Crear un programa que imprima los numeros pares del 100 al 300 usando bucles for

2) Crear un programa que imprima los numeros impares del 100 al 1 usando bucles while

3) Crear un programa que permita el ingreso de los siguientes datos:
    a. Nombre
    b. Apellidos
    c. Salario
    d. Horas trabajadas
...
5) Elaborar un programa que contenga un menu con 5 opciones:
    1. Programa 1
    2. Programa 2
    3. Programa 3
    4. Programa 4
